...
<body data-rsssl="1" class="page-template-default page page-id-2047 woocommerce-no-js tg_menu_transparent tg_lightbox_black leftalign tg_footer_reveal elementor-default elementor-page elementor-page-2047">
                ...
                <div class="inner">
                    <div class="inner_wrapper">
                        <div class="sidebar_content full_width">
                            <div class="elementor elementor-2047">
                                <div class="elementor-inner">
                                    <div class="elementor-section-wrap">
                                        <section data-id="64a2513" class="elementor-element elementor-element-64a2513 elementor-section-height-full elementor-section-boxed elementor-section-height-default elementor-section-items-middle elementor-section elementor-top-section" data-element_type="section">
                                            <div class="elementor-container elementor-column-gap-default">
                                                <div class="elementor-row">
                                                    <div data-id="850bcdd" class="elementor-element elementor-element-850bcdd elementor-column elementor-col-100 elementor-top-column" data-element_type="column">
                                                        <div class="elementor-column-wrap elementor-element-populated">
                                                            <div class="elementor-widget-wrap">
                                                                <div data-id="e2c68e8" class="elementor-element elementor-element-e2c68e8 elementor-widget elementor-widget-photographer-slider-room" data-element_type="photographer-slider-room.default">
                                                                    <div class="elementor-widget-container">
                                                                        <div class="tg_room_slider_wrapper">
                                                                                ...
                                                                                <div class="scroller">
                                                                                    <div class="room room--current">
                                                                                        <div class="room__side room__side--back">
                                                                                            <img class="room__img" src="upload/PettitSevitt_MkV_Ext_Entrance-768x512.jpg" alt="">
                                                                                            <img class="room__img" src="upload/small-home-office-with-white-interior-decoration-ideas-under-wooden-staircase-with-laminate-flooring-tile-parquet-table-kitchen-wall-cabinets-with-door-and-shelvin.jpg" alt=""></div>
                                                                                        <div class="room__side room__side--left">
                                                                                            <img class="room__img" src="upload/d79a08f0c0f0e26dc960695470824495-768x853.jpg" alt="">
                                                                                            <img class="room__img" src="upload/architecture-modern-architects-modern-tritmonk-building-photo-gallery-for-futuristic-exterior-design-idea-reading-santa-spanish-exterior-york-top-and-famous-of-m-1.jpg" alt="">
                                                                                            <img class="room__img" src="upload/xModern-Eco-friendly-House-2.jpg.pagespeed.ic_.el4ZtL7FI9-768x489.jpg" alt=""></div>
                                                                                        <div class="room__side room__side--right">
                                                                                            <img class="room__img" src="upload/Sleek-and-Modern-Interior-by-Marcelo-Mota-Arquitectura-3-768x518.jpg" alt="">
                                                                                            <img class="room__img" src="upload/Mid-Century-Modern-10.-Matt-Gibson-768x512.jpg" alt="">
                                                                                            <img class="room__img" src="upload/minecraft-wood-and-stone-house-exterior-home-design-houzz-best-architecture-house-excerpt-nice-of-minecraft-wood-and-stone-house-768x512.jpg" alt=""></div>
                                                                                        <div class="room__side room__side--bottom"></div>
                                                                                    </div>
                                                                                    <div class="room ">
                                                                                        <div class="room__side room__side--back">
                                                                                            <img class="room__img" src="upload/adi-constantin-85028-unsplash-768x512.jpg" alt="">
                                                                                            <img class="room__img" src="upload/apartment-architecture-bright-day-1024248-768x512.jpg" alt=""></div>
                                                                                        <div class="room__side room__side--left">
                                                                                            <img class="room__img" src="upload/camila-ferrari-190965-unsplash-768x512.jpg" alt="">
                                                                                            <img class="room__img" src="upload/michael-shannon-567440-unsplash-768x1024.jpg" alt="">
                                                                                            <img class="room__img" src="upload/lycs-lycs-744227-unsplash-768x541.jpg" alt=""></div>
                                                                                        <div class="room__side room__side--right">
                                                                                            <img class="room__img" src="upload/julien-rocheblave-545776-unsplash-768x1152.jpg" alt="">
                                                                                            <img class="room__img" src="upload/T17_0168-768x697.jpg" alt="">
                                                                                            <img class="room__img" src="upload/pixasquare-622732-unsplash-768x768.jpg" alt=""></div>
                                                                                        <div class="room__side room__side--bottom"></div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="content">
                                                                                <div class="slides">
                                                                                    <div class="slide">
                                                                                        <h2 class="slide__name">Residential Projects</h2>
                                                                                        <div class="slide__title">
                                                                                            When, while the lovely valley teems with vapour around me, and the meridian sun strikes the upper surface of the impenetrable foliage of my trees.</div>
                                                                                        <p class="slide__date"><a class="button" href="#">View Portfolio</a></p>
                                                                                    </div>
                                                                                    <div class="slide">
                                                                                        <h2 class="slide__name">Commercial Projects</h2>
                                                                                        <div class="slide__title">
                                                                                            Bulla fringilla purus at leo dignissim congue. Mauris elementum accumsan leo vel tempor. Aenean sagittis diam vel enim tempus sit amet cursus nisl aliquam.</div>
                                                                                        <p class="slide__date"><a class="button" href="#">View Portfolio</a></p>
                                                                                    </div>
                                                                                </div>
                                                                                <nav class="nav">
